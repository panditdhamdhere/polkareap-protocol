...
/// @title ScaleCodec
/// @notice SCALE encoding utilities for XCM and Substrate compatibility
/// @dev Polkadot uses little-endian SCALE encoding - convert from big-endian
/// @dev Adapted from paritytech/ethereum-xcm-v3
library ScaleCodec {
